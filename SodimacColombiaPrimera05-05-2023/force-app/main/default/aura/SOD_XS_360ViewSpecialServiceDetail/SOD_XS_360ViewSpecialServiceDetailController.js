...
({
   ...
   handleCreateButton: function (component, event, helper) {
        ...
        /*
        let obj = component.get("v.purchaseDataComponent");
        let obj2 = component.get("v.dataObject");
        
        component.set("v.purchaseDataComponent", obj);
        component.set("v.dataObject", obj2);
        */
    },
